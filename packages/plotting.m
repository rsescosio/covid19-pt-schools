...
plotHistogram[
   ...
   Show[
      Histogram[
         ...
         ImageSize -> 250,
         AxesOrigin -> {0, 0},
         PlotRange -> {Which[Head[AUTOTICKS] === List, AUTOTICKS,
                           True, Automatic],
                        {0, All}}, 
         Frame -> {{True, False}, {True, False}}, 
         FrameStyle -> Directive[Black, sizeFontSmall],
         ChartStyle -> Directive[COLOR],
         ChartBaseStyle -> EdgeForm[{Thickness[Large], White, Opacity[1]}],
         PlotTheme -> "Web",
...
plotBarWithError[
   DATA_,
   COLORS_:{colorBlue, colorOrange}, LABELS_:"", XLABEL_:"", YLABEL_:"", TITLE_:"", YLIMS_:{0, Automatic}, IMAGESIZE_:500,
   ASPECTRATIO_:0.5, BARSPACING_:{0.01, 1}, MIN_:Automatic] :=
   BarChart[
      DATA,
      PlotTheme -> "Web",
      PlotRange -> {MIN, YLIMS},
      ...
      BarSpacing -> BARSPACING,
      ChartStyle -> COLORS, 
      ChartBaseStyle -> EdgeForm[{Thick, White, Opacity[1]}],
      AspectRatio -> ASPECTRATIO,
      PlotLabel -> Style[TITLE,
            FontSize -> sizeFontBig,
            FontColor -> Black,
